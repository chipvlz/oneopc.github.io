...
class PackageLister:
    ...
    def GetScreenshots(self, tweak_data):
        ...
        image_list = []
        try:
            for folder in os.listdir(self.root + "repo/assets/" + tweak_data['bundle_id'] + "/screenshot/"):
                if folder.lower() != ".ds_store":
    ...
    def GetScreenshotSize(self, tweak_data):
        ...
        try:
            for folder in os.listdir(self.root + "repo/assets/" + tweak_data['bundle_id'] + "/screenshot/"):
                if folder.lower() != ".ds_store":
                    with Image.open(self.root + "repo/assets/" + tweak_data['bundle_id'] + "/screenshot/" + folder) as img:
