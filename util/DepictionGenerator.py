...
class DepictionGenerator:
    ...
    def RenderPackageHTML(self, tweak_data):
        ...
        with open(self.root + "Styles/tweak.mustache", "r") as content_file:
            ...
            try:
                with open(self.root + "repo/assets/" + tweak_data['bundle_id'] + "/description.md", "r") as md_file:
                    raw_md = md_file.read()
    ...
    def RenderFooter(self):
        ...
        try:
            ...
            footer = pystache.render("Oneopc {{silica_version}} – Updated {{silica_compile_date}}", data)
        return footer
